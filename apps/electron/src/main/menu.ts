 ...
 * Includes only relevant items for the CraftCodex app.
 *
...
export async function rebuildMenu(): Promise<void> {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    ...(isMac ? [{
      label: 'CraftCodex',
      submenu: [
        { role: 'about' as const, label: 'About CraftCodex' },
        updateMenuItem,
        ...
        { type: 'separator' as const },
        { role: 'hide' as const, label: 'Hide CraftCodex' },
        { role: 'hideOthers' as const },
        { role: 'unhide' as const },
        { type: 'separator' as const },
        { role: 'quit' as const, label: 'Quit CraftCodex' }
      ]
    }] : []),
